...
-- -----------------------------------------------------
-- Table `educacionculturaturismosb`.`plan`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `educacionculturaturismosb`.`plan` ;

CREATE TABLE IF NOT EXISTS `educacionculturaturismosb`.`plan` (
...
CREATE TABLE IF NOT EXISTS `educacionculturaturismosb`.`ambiente` (
  ...
  `idsede` INT NOT NULL,
  `capacidad` INT NULL,
  `nombreambiente` VARCHAR(200) NULL,
...
CREATE TABLE IF NOT EXISTS `educacionculturaturismosb`.`horario` (
  ...
  INDEX `fk_horario_plan1_idx` (`idplan` ASC),
  INDEX `fk_horario_ambiente1_idx` (`idambiente` ASC),
  CONSTRAINT `fk_horario_plan1`
    FOREIGN KEY (`idplan`)
    REFERENCES `educacionculturaturismosb`.`plan` (`idplan`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `educacionculturaturismosb`.`planpublicitario` (
  ...
  INDEX `fk_planpublicitario_plan1_idx` (`idplan` ASC),
  CONSTRAINT `fk_planpublicitario_plan1`
    FOREIGN KEY (`idplan`)
    REFERENCES `educacionculturaturismosb`.`plan` (`idplan`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `educacionculturaturismosb`.`encargado`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `educacionculturaturismosb`.`encargado` ;

CREATE TABLE IF NOT EXISTS `educacionculturaturismosb`.`encargado` (
...
CREATE TABLE IF NOT EXISTS `educacionculturaturismosb`.`cronograma` (
  ...
  INDEX `fk_cronograma_encargado1_idx` (`idencargado` ASC),
  CONSTRAINT `fk_cronograma_horario1`
    FOREIGN KEY (`idhorario`)
    REFERENCES `educacionculturaturismosb`.`horario` (`idhorario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_cronograma_encargado1`
    FOREIGN KEY (`idencargado`)
    REFERENCES `educacionculturaturismosb`.`encargado` (`idencargado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `educacionculturaturismosb`.`detalle_horario_encargado` (
  `idhorario` INT NOT NULL,
  `idencargado` INT NOT NULL,
  PRIMARY KEY (`idhorario`, `idencargado`),
  INDEX `fk_horario_has_encargado_encargado1_idx` (`idencargado` ASC),
  INDEX `fk_horario_has_encargado_horario1_idx` (`idhorario` ASC),
  CONSTRAINT `fk_horario_has_encargado_horario1`
    FOREIGN KEY (`idhorario`)
    REFERENCES `educacionculturaturismosb`.`horario` (`idhorario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_horario_has_encargado_encargado1`
    FOREIGN KEY (`idencargado`)
    REFERENCES `educacionculturaturismosb`.`encargado` (`idencargado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `educacionculturaturismosb`.`detalle_encargado_rol`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `educacionculturaturismosb`.`detalle_encargado_rol` ;

CREATE TABLE IF NOT EXISTS `educacionculturaturismosb`.`detalle_encargado_rol` (
  `idencargado` INT NOT NULL,
  `idrol` INT NOT NULL,
  PRIMARY KEY (`idencargado`, `idrol`),
  INDEX `fk_encargado_has_rol_rol1_idx` (`idrol` ASC),
  INDEX `fk_encargado_has_rol_encargado1_idx` (`idencargado` ASC),
  CONSTRAINT `fk_encargado_has_rol_encargado1`
    FOREIGN KEY (`idencargado`)
    REFERENCES `educacionculturaturismosb`.`encargado` (`idencargado`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_encargado_has_rol_rol1`
    FOREIGN KEY (`idrol`)
...
INSERT INTO `educacionculturaturismosb`.`cronograma` (`idhorario`,`tarea`,`descripcion`,`fechainicio`,`fechafin`,`fechaejecucion`,`idencargado`)VALUES (2,'tarea 1','recolectar nose que cosas','2017-09-19','2017-09-20',null,1);
...
BEGIN
			IF (Val_idperiodo !=0) AND (Val_estado !=0)  THEN
				...
				Select pl.idplan as idplan,
					...
					from plan pl inner join periodo p on pl.idperiodo=p.idperiodo
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `validarActividadPorPeriodo`(IN Val_idperiodo INT, IN Val_idtipoactividad INT, IN Val_idactividad INT)
    DETERMINISTIC
BEGIN
			Select count(pl.idplan) as flagactividadperiodo
			from plan pl inner join periodo p on pl.idperiodo=p.idperiodo and p.idperiodo=Val_idperiodo
...
BEGIN
    ...
    SET @sql = CONCAT('SELECT TB1.idcronograma,TB1.tarea,TB1.descripcion,TB2.nombre,TB2.apellipaterno,
					   ...
					   LEFT JOIN educacionculturaturismosb.encargado TB2
                       ON TB1.idencargado = TB2.idencargado
